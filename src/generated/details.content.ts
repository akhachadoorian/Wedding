...
export const dressCodeCopyOnlyContent: Omit<CopyOnlyProps, "variation" | "headingSize"> = {
  eyebrow: "Dress Code",
  header: "What to Wear",
  body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut lobortis viverra nunc, id bibendum magna vehicula sed. In facilisis cursus neque nec luctus.",
};

export const weddingPartyCopyOnlyContent: Omit<CopyOnlyProps, "variation" | "headingSize"> = {
...
export const fAQsCopyOnlyContent: Omit<CopyOnlyProps, "variation" | "headingSize"> = {
  eyebrow: "FAQs",
  header: "Frequently Asked Questions",
  body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut lobortis viverra nunc, id bibendum magna vehicula sed. In facilisis cursus neque nec luctus.",
};

export const venueMediaWithCopyContent: Omit<MediaWithCopyProps, "media_side" | "headingSize"> = {
  eyebrow: "The Venue",
...
export const heroSmallTextTagHeroContent: Omit<SmallTextTagHeroProps, "loaded"> = {
  eyebrow: "The Details",
