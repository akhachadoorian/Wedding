export type GoldScale = | "--gold-100" | "--gold-200" | "--gold-250" | "--gold-300" | "--gold-400" | "--gold-500" | "--gold-600" | "--gold-700" | "--gold-800" | "--gold-850" | "--gold-900" | "--gold-1000";

export type CreamScale = '--cream' | "--cream-100" | "--cream-300" | "--cream-500" |"--cream-600" | "--cream-700" |"--cream-800" | "--cream-900";
