...
export default function Diamond({ color = "--gold-500", size = {size: {minSize: 16, desiredSize: 16, maxSize: 20}}, className }: DiamondProps) {
    ...
    return (
        <div
            className={cn(
                "size-(--diamond-mobile-size) flex-[0_0_var(--diamond-mobile-size)] aspect-square",
                "md:size-(--diamond-size) md:flex-[0_0_var(--diamond-size)]",
                className,
            )}
            style={sizeStyle}
        >
            
            <svg className="size-full" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none">
